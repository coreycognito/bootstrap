...
var infoPopup;
var startLatitude=44;
var startLongitude=-79.5;  
	...
	geocoder.geocode( { 'address': address}, function(results, status) {
		...
		if (status == google.maps.GeocoderStatus.OK) {
			...
			google.maps.event.addListener(marker, 'click', function() {
				...
				popupText.innerHTML += "Tel: "+ fa[count].childNodes[0].nodeValue+"<br><br><br>";
				popupText.innerHTML +="<div><div id='learn"+count+"' class='link' onClick='doLearn("+count+")'>Learn More</div><div id='email"+count+"' class='link' onClick='doEmail("+count+")'>Email</div></div>"
